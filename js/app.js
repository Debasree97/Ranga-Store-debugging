...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product" id="single-product">
      ...
      <p>Rating: <span id="rating">${product.rating.rate}</span></p>
...
const addToCart = (id, price) => {
  ...
  // Update Deliery-Chrage + Total-Tax
  updateTaxAndCharge();
  // Update Total
  updateTotal();
  // Update Total-Added Productg
  document.getElementById("total-Products").innerText = cartProductCount;
};

// Get innerText and Conversion funtion
